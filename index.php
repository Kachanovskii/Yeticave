...
$category = ['Boards and skis', 'Fastening', 'Shoeos', 'Clother', 'Tools', 'Different'];
$lots = [['title' => '2020 Rassignal District Snowboard',
'category' => 'Board and skis',
'price' => 100,
'URL_image' => 'img/lot-1.jpg'
],
['title' => 'DC Ply Mens 2020/2021 Snowboard',
'category' => 'Board and skis',
'price' => 150,
'URL_image' => 'img/lot-2.jpg'
],
['title' => 'Union Contact Pro 2015',
'category' => 'Board and skis',
'price' => 150,
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <img src=<?= $user_avatar ?> alt="User" width="40" height="40">
        </div>
        ...
        <ul class="lots__list">
            <li class="lots__item lot">
                ...
                <div class="lot__image">
                    <img src=<?= $lots[$i]['URL_image'] ?> width="350" height="260" alt="Сноуборд">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?= $lots[$i]['category'] ?></span>
                    <h3 class="lot__title"><a class="text-link" href="lot.html"><?= $lots[$i]['title']?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?= change_number($lots[$i]['price']) ?></span>
                        </div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            <?php 
            $index = 0;
            while($index < count($category)) {
                ?>
            <li class="nav__item">
                <a href="all-lots.html"><?= $category[$index] ?></a>
            </li>
            <?php $index++; } ?>
        </ul>
    </nav>
